    ...
    <div style={{marginTop:'65px'}}>
            ...
            data.map((product, index) => (
              <div key={index} style={{border:'1px solid black',width:'98%',display:'flex',alignItems:'center'}} className='m-4' >
                ...
                <h1 className='tittle new-font font-bold' style={{maxHeight:"100px", minHeight:'100px',height:'100px'}} onClick={()=>{console.log('cart result.js : ',product._id);navigate(`/Update/${product._id}`)}}>{product.name}</h1>
