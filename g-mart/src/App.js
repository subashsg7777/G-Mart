  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path='/payments/:product_Id' element={<><Offer /><Navbar /><Payment /></>}/>
        <Route path='/cpdetails/:pid' element={<><Offer /> <Navbar /> <CartDetails /></>}/>
        <Route path='/Orders' element = {<><Offer></Offer><Navbar /><Test /></>} />
        <Route path='/Your-Products' element = {<> <Offer /><Navbar /> <Products /> </>}/>
        <Route path='/Update_products' element={<> <Offer /> <Navbar /> <Update_Product /> <Footer /></>} />
        <Route path='/Update/:product_Id' element = {<> <Offer /> <Navbar /> <Update /> <Footer /></>} />
      </Routes>
    </Router>
